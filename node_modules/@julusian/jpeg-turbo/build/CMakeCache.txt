...
# For build in directory: /tmp/build/node_modules/@julusian/jpeg-turbo/build
...
//Build string (default: 20230312)
BUILD:STRING=20230312
...
//ASM_NASM compiler
CMAKE_ASM_NASM_COMPILER:FILEPATH=/usr/bin/yasm
...
CMAKE_ASM_NASM_FLAGS_DEBUG:STRING=-g dwarf2
...
CMAKE_ASM_NASM_FLAGS_RELWITHDEBINFO:STRING=-g dwarf2
...
// files) should be installed (Default: <CMAKE_INSTALL_DATAROOTDIR>/doc)
...
//Directory into which to install jpegturbo (default: /opt/jpegturbo)
CMAKE_INSTALL_PREFIX:PATH=/opt/jpegturbo
...
CMAKE_JS_INC:UNINITIALIZED=/root/.cmake-js/node-x64/v17.9.0/include/node;/tmp/build/node_modules/nan

//No help, variable specified on the command line.
CMAKE_JS_SRC:UNINITIALIZED=

//No help, variable specified on the command line.
CMAKE_JS_VERSION:UNINITIALIZED=5.3.2

//No help, variable specified on the command line.
CMAKE_LIBRARY_OUTPUT_DIRECTORY:UNINITIALIZED=/tmp/build/node_modules/@julusian/jpeg-turbo/build/Release
...
//Value Computed by CMake
CMAKE_PROJECT_NAME:STATIC=jpegturbo
...
//The type of floating point math used by the floating point DCT/IDCT
// algorithms.  This tells the testing system which numerical results
// it should expect from those tests.  [sse = libjpeg-turbo x86/x86-64
// SIMD extensions, 32bit = generic 32-bit FPU or SSE, 64bit =
// generic 64-bit FPU, 387 = 387 FPU, msvc = 32-bit Visual Studio]
// (default = sse)
...
//No help, variable specified on the command line.
NODE_RUNTIMEVERSION:UNINITIALIZED=17.9.0

//E-mail of project maintainer to be included in distribution package
// descriptions (default: information@jpegturbo.org
PKGEMAIL:STRING=information@jpegturbo.org

//Globally unique package identifier (reverse DNS notation) (default:
// com.jpegturbo.jpegturbo)
PKGID:STRING=com.jpegturbo.jpegturbo

//Distribution package name (default: jpegturbo)
PKGNAME:STRING=jpegturbo

//URL of project web site to be included in distribution package
// descriptions (default: http://www.jpegturbo.org)
PKGURL:STRING=http://www.jpegturbo.org

//Vendor name to be included in distribution package descriptions
// (default: The jpegturbo Project)
PKGVENDOR:STRING=The jpegturbo Project
...
//Encode/decode JPEG images with 12-bit samples (implies WITH_ARITH_DEC=0
// WITH_ARITH_ENC=0 WITH_JAVA=0 WITH_SIMD=0 WITH_TURBOJPEG=0 )
WITH_12BIT:BOOL=OFF
...
//Emulate libjpeg v7 API/ABI (this makes jpegturbo backward-incompatible
// with libjpeg v6b)
WITH_JPEG7:BOOL=OFF

//Emulate libjpeg v8 API/ABI (this makes jpegturbo backward-incompatible
// with libjpeg v6b)
WITH_JPEG8:BOOL=OFF
...
//Value Computed by CMake
jpegturbo_BINARY_DIR:STATIC=/tmp/build/node_modules/@julusian/jpeg-turbo/build

//Dependencies for the target
jpegturbo_LIB_DEPENDS:STATIC=general;turbojpeg-static;

//Value Computed by CMake
jpegturbo_SOURCE_DIR:STATIC=/tmp/build/node_modules/@julusian/jpeg-turbo

//Value Computed by CMake
libjpeg-turbo_BINARY_DIR:STATIC=/tmp/build/node_modules/@julusian/jpeg-turbo/build/deps/libjpeg-turbo

//Value Computed by CMake
libjpeg-turbo_SOURCE_DIR:STATIC=/tmp/build/node_modules/@julusian/jpeg-turbo/deps/libjpeg-turbo
...
CMAKE_CACHEFILE_DIR:INTERNAL=/tmp/build/node_modules/@julusian/jpeg-turbo/build
...
// project
CMAKE_HOME_DIRECTORY:INTERNAL=/tmp/build/node_modules/@julusian/jpeg-turbo
...
//Test HAVE_VERSION_SCRIPT
HAVE_VERSION_SCRIPT:INTERNAL=1
//Test INCOMPLETE_TYPES
INCOMPLETE_TYPES:INTERNAL=1
//Test INLINE_WORKS
...
_GNUInstallDirs_CMAKE_INSTALL_LAST_DATAROOTDIR:INTERNAL=
...
_GNUInstallDirs_CMAKE_INSTALL_LAST_DEFAULT_DATAROOTDIR:INTERNAL=
//CMAKE_INSTALL_DEFAULT_DOCDIR during last run
_GNUInstallDirs_CMAKE_INSTALL_LAST_DEFAULT_DOCDIR:INTERNAL=<CMAKE_INSTALL_DATAROOTDIR>/doc
...
_GNUInstallDirs_CMAKE_INSTALL_LAST_DEFAULT_LIBDIR:INTERNAL=lib64
...
_GNUInstallDirs_CMAKE_INSTALL_LAST_DOCDIR:INTERNAL=<CMAKE_INSTALL_DATAROOTDIR>/doc
...
_GNUInstallDirs_CMAKE_INSTALL_LAST_LIBDIR:INTERNAL=lib64
...
//Test __CHAR_UNSIGNED__
__CHAR_UNSIGNED__:INTERNAL=
//Result of TRY_COMPILE
__CHAR_UNSIGNED___COMPILED:INTERNAL=TRUE
//Result of TRY_RUN
__CHAR_UNSIGNED___EXITCODE:INTERNAL=1
